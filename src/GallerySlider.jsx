...
export default function GallerySlider() {
    return (
        <div className="w-full max-w-4xl mx-auto my-12 md:my-20 px-2">
            <Swiper
                ...
                {images.map((src, idx) => (
                    <SwiperSlide key={idx}>
                        <img
                            src={src}
                            alt={`slide ${idx + 1}`}
                            className="w-full h-[320px] md:h-[420px] object-cover object-center rounded-3xl"
                            draggable="false"
                            style={{ maxHeight: "70vw", minHeight: "220px" }}
                        />
                    </SwiperSlide>
                ))}
            </Swiper>
